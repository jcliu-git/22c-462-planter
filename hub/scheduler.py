...
async def startScheduler(services: Services):
    try:
        ...
        scheduler.add_job(services.insertLight, "interval", seconds=30)
        scheduler.add_job(services.insertTemperature, "interval", seconds=30)
        scheduler.add_job(services.insertWaterLevel, "interval", seconds=30)
        scheduler.start()
